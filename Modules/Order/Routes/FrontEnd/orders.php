...
Route::group(['prefix' => 'orders'], function () {
    ...
    Route::get('success-tabby', 'FrontEnd\OrderController@HandleTabby')
        ->name('frontend.orders.success.tabby');

    Route::get('cancel-tabby', 'FrontEnd\OrderController@HandleTabby')
        ->name('frontend.orders.cancel.tabby');

    Route::get('failure-tabby', 'FrontEnd\OrderController@HandleTabby')
        ->name('frontend.orders.failure.tabby');
