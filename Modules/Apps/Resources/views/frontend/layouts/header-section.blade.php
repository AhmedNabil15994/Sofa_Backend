...
{{--                        <li class="menu-item-has-children ">--}}
{{--                            <form  action="{{ route('frontend.updateCurrency') }}" id="update-currency" method="post">--}}
{{--                            @csrf--}}
{{--                            {!! field('frontend_no_label')->select('currency_id',--}}
{{--                            __('user::frontend.addresses.form.select_currency'),$new_supported_currencies ,--}}
            ...
            <div class="container">
                <div class="header-menu">
                    <ul class="header-nav">
                        ...
                        @if($ourBranches)
                            <li>
                                <a href="{{ $terms ? route('frontend.pages.index', $ourBranches->slug) : '#' }}">{{ __('apps::frontend.master.our_branches') }}</a>
                            </li>
                        @endif
                        @if($beforeBuy)
                            <li>
                                <a href="{{ $terms ? route('frontend.pages.index', $beforeBuy->slug) : '#' }}">{{ __('apps::frontend.master.before_buy') }}</a>
                            </li>
                        @endif
                        <li>
